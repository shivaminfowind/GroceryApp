...
const ShoppingCartScreen2 = ({navigation}) => {
    return (
            ...
            <View style={style.Container}>
                ...
                <View style={style.MiddleView}>
                    <View style={style.loginForm}>
                        ...
                        <View style={{width:375,height:212, marginTop:-300,justifyContent: 'center', alignItems: 'center', opacity: 0.2 }}>
...
export default ShoppingCartScreen2;