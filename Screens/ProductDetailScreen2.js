            ...
            <View style={style.Container}>
                <View style={style.TopView}>
                    <View style={{flexDirection:'row',height:44}}>
                        ...
                        <View style={{width:14,height:14,marginLeft:46,marginTop:24}}>
                            <Image source={require('../Asset/grocies/heart_outline.png')} />
                        </View>
                        <View style={{width:16,height:14,marginLeft:10,marginTop:24}}>
                ...
                <View style={style.MiddleView}>
                    ...
                    <View style={{width:65,height:13,marginTop:5,marginLeft:25}}>
                    ...
                    <View style={{marginTop:5,borderTopRightRadius:80,height:273,marginLeft:-20,width:375,backgroundColor:'#B7FFD6'}}>
                        
                            
                            <View style={{marginTop:5,marginLeft:45,width:193,height:19}}>
                                <Text style={{fontFamily:'Montserrat-ExtraBold',fontSize:15}}>PRODUCT DESCRIPTION</Text>
                            </View>
                        
                        <View style={{flexDirection:'row',marginTop:7,marginLeft:45,alignItems:'center'}}>
                        ...
                        <View style={{marginLeft:45, flexDirection:'row',marginTop:9}}>
                        ...
                        <View style={{height:33,marginTop:16,flexDirection:'row',marginLeft:45}}>
                            ...
                            <View style={{justifyContent:'center',alignItems:'center',width:36,height:33, backgroundColor:'#FF4600',marginLeft:9,borderTopRightRadius:5,borderTopLeftRadius:5,borderBottomLeftRadius:5}}>
                                ...
                                <Image style={{width:15,height:15}} source={require('../Asset/grocies/whiteheart.png')} />
                                </View>
                            </View>
                            
                        </View>
                    </View>
                    <View style={{width:97.4,height:115,marginLeft:260,marginTop:-240}}>
                    <Image style={{width:97.4,height:115}} source={require('../Asset/grocies/Page-2.png')} />
                    </View>
                </View>
