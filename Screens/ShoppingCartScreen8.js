...
const ShoppingCartScreen8 = ({navigation}) => {
    return (
                    ...
                    <View style={style.loginForm}>
                        ...
                        <View style={{marginTop:29.37,width:309.4,height:321.88,alignItems:'center'}}>
                            ...
                            <View style={{alignItems:'center',marginTop:45}}>
                                <Image source={require('../Asset/grocies/searching.png')} />
                            </View>
                        </View>
                        <View style={{width:270,height:27,marginTop:6.75}}>
                            <Text style={{fontFamily:'Montserrat-Bold',fontSize:22}}>Oops... No result found!</Text>
                        </View>
                        <View style={{width:190,height:38,alignItems:'center',marginTop:5}}>
                            <Text style={{fontFamily:'Montserrat-Medium',fontSize:15}}>May be go back and try</Text>
                            <Text style={{fontFamily:'Montserrat-Medium',fontSize:15}}>a different keyword.</Text>
                        </View>        

                        <View style={{marginTop:34, flexDirection: 'row', borderRadius: 30, backgroundColor: '#009440', width: 203, height: 55, justifyContent: 'center', alignItems: 'center' }}>
                            <View>
                                <TouchableOpacity>
                                    <Text style={{ marginLeft: 20, width: 130, height: 24, color: '#FFFFFF', fontFamily: 'Montserrat-SemiBold', fontSize: 18 }}>GO TO HOME</Text>
                                </TouchableOpacity>
                            </View>
...
export default ShoppingCartScreen8;