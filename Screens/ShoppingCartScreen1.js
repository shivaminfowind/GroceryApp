...
const ShoppingCartScreen1 = ({navigation}) => {
    return (
            ...
            <View style={style.Container}>
                ...
                <View style={style.MiddleView}>
                    <View style={style.loginForm}>
                        ...
                        <View style={style.ChkBar2}>
                            <Text style={{fontFamily:'Montserrat-SemiBold',fontSize:13}}>02</Text>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{backgroundColor:'#D8D8D8',width:7,height:74,marginLeft:33}}></View>
                            <View style={{marginLeft:10,marginTop:20}}>
                                <Image source={require('../Asset/grocies/truck.png')} />
                            </View>
                            <View style={{marginLeft:19}}>
                                <View>
                                    <Text style={{fontFamily:'Montserrat-Bold',fontSize:16}}>ORDER SHIPPED</Text>
                                </View>
                                <View style={{marginTop:5}}>
                        ...
                        <View style={style.ChkBar2}>
                            <Text style={{fontFamily:'Montserrat-SemiBold',fontSize:13}}>03</Text>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{backgroundColor:'#D8D8D8',width:7,height:74,marginLeft:33}}></View>
                            <View style={{marginLeft:10,marginTop:20}}>
                            ...
                            <View style={{marginLeft:19}}>
                                <View>
                                    <Text style={{fontFamily:'Montserrat-Bold',fontSize:16}}>ORDER ON THE WAY</Text>
                                </View>
                                <View style={{marginTop:5}}>
                        ...
                        <View style={style.ChkBar2}>
                            <Text style={{fontFamily:'Montserrat-SemiBold',fontSize:13}}>04</Text>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{backgroundColor:'#D8D8D8',width:7,height:74,marginLeft:33}}></View>
                            ...
                            <View style={{marginLeft:19}}>
                                <View>
                                    <Text style={{fontFamily:'Montserrat-Bold',fontSize:16}}>ORDER DELIVERED</Text>
                                </View>
                                <View style={{marginTop:5}}>
...
export default ShoppingCartScreen1;