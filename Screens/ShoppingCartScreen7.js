...
const ShoppingCartScreen7 = ({navigation}) => {
    return (
                    ...
                    <View style={style.loginForm}>
                        ...
                        <View style={{marginTop:29.37,width:309.4,height:321.88,alignItems:'center'}}>
                            <View style={{alignItems:'center',marginTop:20}}>
                                <Text style={{fontFamily:'Montserrat-Bold',fontSize:22}}>Wishlist</Text>
                            </View>
                            <View style={{alignItems:'center',marginTop:45}}>
                                <View>
                                    <Image source={require('../Asset/grocies/sad.png')} />
                                </View>
                                <View style={{justifyContent:'center',alignItems:'center',backgroundColor:'white',marginLeft:110,width:60,height:60,marginTop:-150}}>
                                    <Image source={require('../Asset/grocies/heart.png')} />
                                </View>

                                
                            </View>
                        </View>
                        <View style={{alignItems:'center',width:205,height:54,marginTop:6.75}}>
                            <Text style={{fontFamily:'Montserrat-Bold',fontSize:22}}>Hey, Your wishlist</Text>
                            <Text style={{fontFamily:'Montserrat-Bold',fontSize:22}}>is empty!</Text>
                        </View>
                        <View style={{width:298,height:19,alignItems:'center',marginTop:2}}>
                            <Text style={{fontFamily:'Montserrat-Medium',fontSize:15}}>Explore more and shortlist some items.</Text>
...
export default ShoppingCartScreen7;